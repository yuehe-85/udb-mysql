...
| 计费项   | 中国大陆     | 新加坡、印度尼西亚（雅加达）、英国（伦敦）、德国（法兰克福）、俄罗斯（莫斯科） | 香港B、台湾（台北）及海外其它地域 |
| :--- | :---         | :---                 | :---                      |
...
| 计费项 | 华北（乌兰察布）（乌兰察布）                                  | 中国大陆（除华北（乌兰察布）） | 新加坡、印度尼西亚（雅加达）、英国（伦敦）、德国（法兰克福）、俄罗斯（莫斯科） | 香港B、台湾（台北）及海外其它地域 |
| :----- | :-------------------------------------------------- | -------------------- | :------------------------------------- | :------------------------ |
...
实例费用=(CPU规格×CPU单价+内存规格×内存单价+硬盘规格×硬盘单价)×时长 + 备份费用
