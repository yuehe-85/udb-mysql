...
## 计算规格介绍
云数据库 MySQL 提供多种计算规格类型，满足不同业务场景需求：
...
| **O2型** | O2型将提供较NVMe型更新一代的处理器，提供更卓越的计算性能，适用于超高性能数据库场景 | RSSD云盘 | CPU内存比：1:2/1:4/1:8<br>最大内存：512GB | 适用于高频交易、实时分析、AI 数据服务、大型游戏、电商大促、企业核心业务系统等对数据库计算性能和并发能力要求极高的场景 |
